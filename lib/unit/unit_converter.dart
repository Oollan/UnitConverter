...
class UnitConverter extends StatefulWidget {
  ...
  @override
  State createState() => _UnitConverterState();
}
...
class _UnitConverterState extends State<UnitConverter> {
  ...
  Future _updateConversion() async {
    if (widget.category.name == Api().apiCategory['name']) {
      final conversion = await Api().convert(Api().apiCategory['route'],
  ...
  Widget _createDropdown(String currentValue, ValueChanged onChanged) {
    return Container(
  ...
  Widget build(BuildContext context) {
    if (widget.category.units == null ||
        (widget.category.name == Api().apiCategory['name'] && _showErrorUI))
